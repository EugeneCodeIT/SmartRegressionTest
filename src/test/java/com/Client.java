...
abstract public class Client
{
    ...
    /**
     * @see Client#decode(InputStream, int)
     */
    ...
    public Captcha decode(File f, int timeout)
        throws IOException, FileNotFoundException, Exception, InterruptedException
    {
        return this.decode(this.load(f), timeout);
    }

    /**
     * @see Client#decode(File, int)
     */
